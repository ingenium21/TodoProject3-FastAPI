...
def test_read_all_authenticated(test_todo):
    ...
    assert response.json() == [{"title": "learn to code", "description": "need to learn every day", "priority": 5, "complete": False, "owner_id": 1, "id": 1}]
...
def test_read_one_authenticated_not_found():
    ...
    assert response.json() == {"detail": "Todo with the id 999 not found"}
...
def test_update_todo(test_todo):
    ...
    assert model.title == "Changed the title of the todo already saved!"
